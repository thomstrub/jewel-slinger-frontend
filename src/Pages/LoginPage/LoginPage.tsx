...
export default function LoginPage(){
    ...
    const googleLogin = () => {
        window.open("https://jewel-slinger-backend.herokuapp.com/auth/login/google", "_self");
        console.log("google firing<--------")
    }

    const instagramLogin = () => {
        window.open("https://jewel-slinger-backend.herokuapp.com/auth/login/instagram", "_self");
        console.log("instagram firing<--------")
    }

    const githubLogin = () => {
        window.open("https://jewel-slinger-backend.herokuapp.com/auth/login/github", "_self");
        console.log("github firing<--------")
    }
    const twitterLogin = () => {
        window.open("https://jewel-slinger-backend.herokuapp.com/auth/login/twitter", "_self");
